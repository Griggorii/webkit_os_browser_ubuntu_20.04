...
Так же я призываю все конторы типа аипл , самсунгов , ораклов не пририсовывать себя в автосгенерированные мной и другими инклюд фаилы даже если вы туда внесли чуть чуть изменений эти фаилы создаются вида SPDX-License-Identifier: Apache-2.0 потому что что после дезассамблирования вылезает куча накладок в загаловке то этот фаил создан ораклом , позже аиби эм и после эиплом машина всегда может поднять на первое место перво источник.
